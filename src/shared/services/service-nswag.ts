...
//      * @return Success
//      */
//     uploadDocumentToAzure(file: FileParameter | undefined): Observable<void> {
//         let url_ = this.baseUrl + "/api/Document/UploadDocumentToAzure";
//         url_ = url_.replace(/[?&]$/, "");
...
//         return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
//             return this.processUploadDocumentToAzure(response_);
//         })).pipe(_observableCatch((response_: any) => {
//             if (response_ instanceof HttpResponseBase) {
//                 try {
//                     return this.processUploadDocumentToAzure(response_ as any);
//                 } catch (e) {
//                     return _observableThrow(e) as any as Observable<void>;
//                 }
//             } else
...
//     protected processUploadDocumentToAzure(response: HttpResponseBase): Observable<void> {
//         const status = response.status;
//         const responseBlob =
//             response instanceof HttpResponse ? response.body :
//             (response as any).error instanceof Blob ? (response as any).error : undefined;
...
// C:\Users\emre_\source\AngularDigitalArchiveClient\nswag\service.extensions.ts